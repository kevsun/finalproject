...
st.write('TLC dataset includes information about pick-up and drop-off dates/times, pick-up and drop-off locations, trip distances, itemized fares, rate types, payment types, and driver-reported passenger counts. However, the TLC dataset also came originally in PARQUET format, which was a new unfamiliar file format to us, but thankfully, we were able to still process it using pandas')
st.image('https://media.licdn.com/dms/image/C5612AQFviPAObTww9w/article-cover_image-shrink_720_1280/0/1622149825907?e=2147483647&v=beta&t=81kHbHOKu1R8XCpIx2GbAa0Fmj2-b92RzeQY96AGgNU')
...
st.image('https://assets3.thrillist.com/v1/image/1697475/1200x600/scale;')
